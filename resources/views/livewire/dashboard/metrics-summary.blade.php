        ...
        <div class="flex items-center justify-between h-full">
            <div>
                ...
                <p class="text-3xl font-bold"
                   x-data="{
                       displayed: {{ $this->metrics->get('total_revenue') }},
                       target: {{ $this->metrics->get('total_revenue') }},
                       animating: false
                   }"
                   x-init="
                       $watch('target', (newVal, oldVal) => {
                           if (animating || newVal === oldVal) return;
                           animating = true;
                           let start = displayed;
                           let change = newVal - start;
                           let duration = 800;
                           ...
                           let doAnimate = () => {
                               ...
                               if (elapsed < duration) {
                                   displayed = start + (change * (elapsed / duration));
                   ...
                   "
                   x-text="'£' + Math.round(displayed).toLocaleString()">
                </p>
    ...
    <div class="bg-gradient-to-br from-emerald-500 to-emerald-600 rounded-xl shadow-sm p-6 text-white h-32">
        <div class="flex items-center justify-between h-full">
            <div>
                ...
                <p class="text-3xl font-bold"
                   x-data="{
                       displayed: {{ $this->metrics->get('total_orders') }},
    ...
    <div class="bg-gradient-to-br from-purple-500 to-purple-600 rounded-xl shadow-sm p-6 text-white h-32">
        <div class="flex items-center justify-between h-full">
            <div>
                ...
                <p class="text-3xl font-bold"
                   x-data="{
                       displayed: {{ $this->metrics->get('average_order_value') }},
    ...
    <div class="bg-gradient-to-br from-orange-500 to-orange-600 rounded-xl shadow-sm p-6 text-white h-32">
        <div class="flex items-center justify-between h-full">
            <div>
                ...
                <p class="text-3xl font-bold"
                   x-data="{
                       displayed: {{ $this->metrics->get('total_items') }},
        ...
        <div class="bg-gradient-to-br from-pink-500 to-rose-600 rounded-xl shadow-sm p-6 text-white h-32">
            <div class="flex items-center justify-between h-full">
                <div>
                    ...
                    <p class="text-3xl font-bold"
                       x-data="{
                           displayed: {{ $this->bestDay['revenue'] }},
