    ...
    private function importNewProcessedOrder(array $processedOrderData): void
    {
        DB::transaction(function () use ($processedOrderData) {
            ...
            $order = Order::create([
                ...
                'channel_name' => $processedOrderData['order_source'] ?? $processedOrderData['channel_name'] ?? 'Unknown',
                'sub_source' => $processedOrderData['subsource'] ?? $processedOrderData['sub_source'] ?? null,
