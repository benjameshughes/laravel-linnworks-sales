...
Route::prefix('search')->name('api.search.')->middleware('auth:sanctum')->group(function () {
...
// Admin API endpoints
Route::prefix('admin')->name('api.admin.')->middleware(['auth:sanctum', 'can:manage-settings'])->group(function () {
